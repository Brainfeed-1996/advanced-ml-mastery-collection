...
### Interactive
```bash
jupyter notebook 05-Computer-Vision/Autoencoders-Denoising.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  05-Computer-Vision/Autoencoders-Denoising.ipynb --output Autoencoders-Denoising.ipynb --output-dir 05-Computer-Vision
```
