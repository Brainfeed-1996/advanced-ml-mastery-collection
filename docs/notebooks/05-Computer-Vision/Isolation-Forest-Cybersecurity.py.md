...
### Interactive
```bash
jupyter notebook 05-Computer-Vision/Isolation-Forest-Cybersecurity.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  05-Computer-Vision/Isolation-Forest-Cybersecurity.ipynb --output Isolation-Forest-Cybersecurity.ipynb --output-dir 05-Computer-Vision
```
