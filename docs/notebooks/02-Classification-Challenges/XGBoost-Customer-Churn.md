...
### Interactive
```bash
jupyter notebook 02-Classification-Challenges/XGBoost-Customer-Churn.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  02-Classification-Challenges/XGBoost-Customer-Churn.ipynb --output XGBoost-Customer-Churn.ipynb --output-dir 02-Classification-Challenges
```
