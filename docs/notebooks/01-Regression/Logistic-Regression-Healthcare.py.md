...
### Interactive
```bash
jupyter notebook 01-Regression/Logistic-Regression-Healthcare.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  01-Regression/Logistic-Regression-Healthcare.ipynb --output Logistic-Regression-Healthcare.ipynb --output-dir 01-Regression
```
