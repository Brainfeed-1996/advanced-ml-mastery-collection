...
### Interactive
```bash
jupyter notebook 03-Clustering-Techniques/LSTM-Stock-Prediction.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  03-Clustering-Techniques/LSTM-Stock-Prediction.ipynb --output LSTM-Stock-Prediction.ipynb --output-dir 03-Clustering-Techniques
```
