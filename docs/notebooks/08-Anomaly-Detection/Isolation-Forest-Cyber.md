...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Isolation-Forest-Cyber.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Isolation-Forest-Cyber.ipynb --output Isolation-Forest-Cyber.ipynb --output-dir 08-Anomaly-Detection
```
