...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/KNN-Recommender-Systems.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/KNN-Recommender-Systems.ipynb --output KNN-Recommender-Systems.ipynb --output-dir 08-Anomaly-Detection
```
