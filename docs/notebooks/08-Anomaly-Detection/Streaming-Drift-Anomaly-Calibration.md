# Streaming-Drift-Anomaly-Calibration

**Folder:** `08-Anomaly-Detection`

**Last updated:** 2026-02-16 16:29:34

## Purpose

Notebook project (see notebook for details)
...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Streaming-Drift-Anomaly-Calibration.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Streaming-Drift-Anomaly-Calibration.ipynb --output Streaming-Drift-Anomaly-Calibration.ipynb --output-dir 08-Anomaly-Detection
```
