...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Autoencoders-Network-Security.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Autoencoders-Network-Security.ipynb --output Autoencoders-Network-Security.ipynb --output-dir 08-Anomaly-Detection
```
