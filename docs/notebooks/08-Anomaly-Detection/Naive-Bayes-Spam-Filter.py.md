...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Naive-Bayes-Spam-Filter.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Naive-Bayes-Spam-Filter.ipynb --output Naive-Bayes-Spam-Filter.ipynb --output-dir 08-Anomaly-Detection
```
