...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Gradient-Boosting-Insurance.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Gradient-Boosting-Insurance.ipynb --output Gradient-Boosting-Insurance.ipynb --output-dir 08-Anomaly-Detection
```
