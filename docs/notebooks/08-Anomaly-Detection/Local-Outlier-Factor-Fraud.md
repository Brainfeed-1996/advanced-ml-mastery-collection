...
### Interactive
```bash
jupyter notebook 08-Anomaly-Detection/Local-Outlier-Factor-Fraud.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  08-Anomaly-Detection/Local-Outlier-Factor-Fraud.ipynb --output Local-Outlier-Factor-Fraud.ipynb --output-dir 08-Anomaly-Detection
```
