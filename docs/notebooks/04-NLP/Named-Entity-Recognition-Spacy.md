...
### Interactive
```bash
jupyter notebook 04-NLP/Named-Entity-Recognition-Spacy.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  04-NLP/Named-Entity-Recognition-Spacy.ipynb --output Named-Entity-Recognition-Spacy.ipynb --output-dir 04-NLP
```
