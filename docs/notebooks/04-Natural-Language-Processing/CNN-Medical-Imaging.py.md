...
### Interactive
```bash
jupyter notebook 04-Natural-Language-Processing/CNN-Medical-Imaging.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  04-Natural-Language-Processing/CNN-Medical-Imaging.ipynb --output CNN-Medical-Imaging.ipynb --output-dir 04-Natural-Language-Processing
```
