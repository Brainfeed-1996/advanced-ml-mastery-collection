...
Train a reinforcement learning agent to solve CartPole environment
...
Run the notebook to train an RL agent. Monitor training progress.

## Expected Outputs

Trained RL agent, training curves, agent performance metrics
...
### Interactive
```bash
jupyter notebook 04-Natural-Language-Processing/RL-CartPole-Agent.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  04-Natural-Language-Processing/RL-CartPole-Agent.ipynb --output RL-CartPole-Agent.ipynb --output-dir 04-Natural-Language-Processing
```
