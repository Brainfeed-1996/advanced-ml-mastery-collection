...
### Interactive
```bash
jupyter notebook 07-Time-Series/Prophet-Market-Trends.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  07-Time-Series/Prophet-Market-Trends.ipynb --output Prophet-Market-Trends.ipynb --output-dir 07-Time-Series
```
