...
### Interactive
```bash
jupyter notebook 07-Time-Series/ARIMA-Sales-Forecasting.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  07-Time-Series/ARIMA-Sales-Forecasting.ipynb --output ARIMA-Sales-Forecasting.ipynb --output-dir 07-Time-Series
```
