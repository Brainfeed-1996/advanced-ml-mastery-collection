...
### Interactive
```bash
jupyter notebook 10-MLOps/Model-Quantization-TensorRT.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  10-MLOps/Model-Quantization-TensorRT.ipynb --output Model-Quantization-TensorRT.ipynb --output-dir 10-MLOps
```
