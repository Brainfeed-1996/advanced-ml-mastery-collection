...
### Interactive
```bash
jupyter notebook 09-Generative-AI/Named-Entity-Recognition-Spacy.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  09-Generative-AI/Named-Entity-Recognition-Spacy.ipynb --output Named-Entity-Recognition-Spacy.ipynb --output-dir 09-Generative-AI
```
