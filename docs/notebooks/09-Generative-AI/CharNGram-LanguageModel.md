...
### Interactive
```bash
jupyter notebook 09-Generative-AI/CharNGram-LanguageModel.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  09-Generative-AI/CharNGram-LanguageModel.ipynb --output CharNGram-LanguageModel.ipynb --output-dir 09-Generative-AI
```
