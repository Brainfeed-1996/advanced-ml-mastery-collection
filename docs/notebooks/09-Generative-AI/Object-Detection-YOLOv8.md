...
### Interactive
```bash
jupyter notebook 09-Generative-AI/Object-Detection-YOLOv8.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  09-Generative-AI/Object-Detection-YOLOv8.ipynb --output Object-Detection-YOLOv8.ipynb --output-dir 09-Generative-AI
```
