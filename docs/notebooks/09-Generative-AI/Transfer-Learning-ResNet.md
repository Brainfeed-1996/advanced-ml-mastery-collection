...
### Interactive
```bash
jupyter notebook 09-Generative-AI/Transfer-Learning-ResNet.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  09-Generative-AI/Transfer-Learning-ResNet.ipynb --output Transfer-Learning-ResNet.ipynb --output-dir 09-Generative-AI
```
