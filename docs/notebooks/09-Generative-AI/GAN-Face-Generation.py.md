...
### Interactive
```bash
jupyter notebook 09-Generative-AI/GAN-Face-Generation.ipynb
```

### Headless (with outputs)
```bash
python -m jupyter nbconvert --to notebook --execute \
  09-Generative-AI/GAN-Face-Generation.ipynb --output GAN-Face-Generation.ipynb --output-dir 09-Generative-AI
```
